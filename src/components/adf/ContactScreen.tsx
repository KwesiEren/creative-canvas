  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 md:px-10 py-10 space-y-12 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        {/* Contact Form Column */}
        <div className="lg:col-span-7 bg-white dark:bg-[#0a1128] border-2 border-[#0f1b3d] rounded-none p-6 md:p-8 shadow-md">
          <h2 className="text-2xl font-bold text-[#0f1b3d] dark:text-white mb-2">
          ...
          {submitted ? (
            <div className="p-6 bg-[#e8edf3] border border-[#245a86] text-[#0f1b3d] rounded-none space-y-3">
              ...
              <button
                ...
                className="mt-2 px-4 py-2 bg-[#0f1b3d] text-white font-bold text-xs rounded-none"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-[#0f1b3d] dark:text-[#dbe6f2] mb-1">
                    Full Name *
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full p-2.5 bg-[#f4f7fa] dark:bg-[#152a4a] border border-[#c4c6cf] rounded-none text-sm text-[#0a1128] dark:text-white"
                  />
                </div>
                <div>
                  <label className="block text-xs font-bold text-[#0f1b3d] dark:text-[#dbe6f2] mb-1">
              ...
              <div>
                <label className="block text-xs font-bold text-[#245a86] dark:text-[#a8c6e4] mb-1">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-[#245a86] hover:bg-[#0f1b3d] text-white font-bold rounded-none transition-colors cursor-pointer text-sm shadow"
              >
                Send Message
              </button>
            </form>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-[#0f1b3d] text-white rounded-none p-6 space-y-4 shadow-md">
            <h3 className="text-xl font-bold flex items-center gap-2">
              <span className="material-symbols-outlined text-[#a8c6e4]">location_city</span>
              <span>Continental Headquarters</span>
            </h3>
            <div className="text-xs text-[#dbe6f2] space-y-1.5 leading-relaxed">
          ...
          <div className="bg-[#e8edf3] dark:bg-[#152a4a] border border-[#c4c6cf] rounded-none p-6 space-y-4">
            <h3 className="text-lg font-bold text-[#0f1b3d] dark:text-white flex items-center gap-2">
              <span className="material-symbols-outlined text-[#245a86]">hub</span>
              <span>Regional Hub Secretariats</span>
            </h3>
            <div className="divide-y divide-[#c4c6cf] dark:divide-[#33415c] text-xs space-y-3 pt-1">
              <div className="pt-2">
                <p className="font-bold text-[#0f1b3d] dark:text-[#dbe6f2]">East Africa Hub (Nairobi)</p>
                <p className="text-[#33415c] dark:text-[#c4c6cf]">UDPK Complex, Waiyaki Way, Nairobi, Kenya</p>
                <p className="text-[#5b6b85]">eastafrica@adf-africa.org</p>
              </div>
              <div className="pt-3">
                <p className="font-bold text-[#0f1b3d] dark:text-[#dbe6f2]">West Africa Hub (Dakar)</p>
                <p className="text-[#33415c] dark:text-[#c4c6cf]">Sacré-Cœur 3, Villa 92, Dakar, Senegal</p>
                <p className="text-[#5b6b85]">westafrica@adf-africa.org</p>
              </div>
            </div>
          </div>
        </div>
